...
uint256 hashGenesisBlock("0xf339c8a266df7541e8ceea741e954e6cbd382ff397d9c747b7cc9e8f73635087");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // MetaFXCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MetaFXCoin Signed Message:\n";
...
{
    // MetaFXCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // MetaFXCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // MetaFXCoin: 3.5 days
static const int64 nTargetSpacing = 150; // MetaFXCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MetaFXCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // MetaFXCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // MetaFXCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1eb2840f9234e7c9ca56d4ac894feb44460e77755d7b70a3a81f16726f54f340");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9500a65d2ebe47075a5df17bbb588eea198a4f4f8816933b0b8df906f1075233f1dc53a8666d0d0ccb8e346125ff242c45fcb4cf67291d34710e8c25432a4f3337") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1506716137;
        block.nBits    = 504365644;
        block.nNonce   = 1458556941;

        if (fTestNet)
        {
            block.nTime    = 1506716137;
            block.nNonce   = 3811557993;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2e95b6e4a8cdef0a5d19ad6b23e2300bb1943ad9b4968075d441566a50278cb8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // MetaFXCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MetaFXCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MetaFXCoinMiner : ProcessBlock, block not accepted");
    }
